...
export class SearchBarComponent implements OnInit {
  ...
  constructor(private Link : LinkService, private router: Router,private http: HttpClient,private api: ApiService,private playerToShow: PlayerToShowService) { }
  ...
  showStats(){
      ...
      this.StatsToSave.idAccount = this.Link.Link.idAccount;
